...
hidden if the `httpfileserver_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `httpfileserver_DEVELOPER_MODE` to the configure
...
Runs the executable target `httpfileserver_exe`.
